...
/*   Updated: 2023/03/07 12:18:27 by loumarti         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
// static void	put_color_topix(t_img *img, t_pnt pos, int color)
// {
// 	int	*buffer;

// 	buffer = img->buff + (pos.y * img->line) / 4 + (pos.x * img->bppx / 8) / 4;
// 	*buffer = color;
// }
